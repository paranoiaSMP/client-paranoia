        ...
        {connected && account ? (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 bg-panel border border-line px-3 py-1.5 rounded-lg hover:border-line-hi transition-colors"
            >
              <img
              ...
              <ChevronDown
                className={`w-3.5 h-3.5 text-muted-dim transition-transform ${menuOpen ? "rotate-180" : ""}`}
              />
            </button>
                ...
                <div className="absolute right-0 top-full mt-2 w-64 bg-panel border border-line rounded-xl shadow-2xl z-50 overflow-hidden">
                      ...
                      {accounts
                        ...
                        .map((a) => (
                          <button
                            ...
                            className="w-full flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-line transition-colors"
                          >
                            <img
                  ...
                  <div className="p-2">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-line transition-colors text-muted text-sm"
                    >
